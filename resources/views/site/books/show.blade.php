            ...
            <div class="summary-container">
                ...
                <p class="summary" id="summary"> {{ $book->summary }}
                    ...
                    <div class="categories">
                        ...
                        <a href="{{ route('site.category.show', compact('category')) }}"
                                        ...
                                        <div class="user-info">
                                            ...
                                            <div class="dropdown">
                                                <button class="dropbtn" type="submit">
                                                    <img src="{{url('/img/settings.png')}}" width="19">
                                                </button>
                                    ...
                                    <div class="interaction-container">
                                        <div class="add-interaction" id="add-interaction">
                                            ...
                                            <form action="/books/reviews/{{ $review->id }}/like" method="POST">
                                                @csrf
                                                <button type="submit">
                                                    <img src="{{ $review->isLikedBy(auth()->user()) ? url('/img/like/active-like.png') : url('/img/like/unactive-like.png') }}"
                                                        alt="" width="30" height="auto" id="like" class="offline">
                                                </button>
                                            </form>
                                            ...
                                            <form action="/books/reviews/{{ $review->id }}/like" method="POST">
                                                ...
                                                @method('DELETE')
                                                <button type="submit">
                                                    <img src="{{ $review->isDislikedBy(auth()->user()) ? url('/img/like/active-dislike.png') : url('/img/like/unactive-dislike.png') }}"
                                                        alt="" width="30" height="auto" id="dislike" class="offline">
                                                </button>
                                            </form>
                    ...
                    <div class="add-review">
                        <form method="POST" action="{{ route('site.reviews.store', compact('book')) }}">
                            ...
                            <div class="user-container">
                                <img src="{{ Auth::user() ? asset(Auth::user()->image) : 'https://emblemsbf.com/img/77148.webp' }}"
        ...
        <div class="side-col-3">
            <div class="author-container">
                ...
                <div class="author-summary">
                    Samuel Langhorne Clemens, known by his pen name Mark Twain, was an American writer, humorist,
                    entrepreneur, publisher, and lecturer. He was lauded as the "greatest humorist [the United States]
                    has produced", and William Faulkner called him "the father of American literature
                </div>
            </div>
